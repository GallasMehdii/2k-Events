  ...
  const teamMembers = [
    {
      ...
      description: "With over 15 years of experience in curating luxury weddings, Sarah transforms dreams into reality with elegance and precision.",
    ...
    },
    {
      ...
      description: "A master of sophisticated wedding aesthetics, Michael brings visionary artistry to every event, ensuring elegance in every detail.",
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative bg-black text-white py-48 overflow-hidden">
        <div className="container mx-auto px-6 text-center relative">
          <h1 className="text-6xl font-extrabold leading-tight mb-12 tracking-wide animate-fadeIn">
            Crafting Unforgettable Experiences
          </h1>
          <p className="text-xl max-w-2xl mx-auto mb-16 animate-fadeIn delay-200 opacity-80">
          ...
          <a
            href="#services"
            className="border-2 border-white py-3 px-8 rounded-full text-xl font-semibold uppercase hover:bg-white hover:text-black transition-all duration-300 transform hover:scale-105 animate-fadeIn delay-300"
          >
      ...
      <section id="about" className="py-24 bg-black text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-lg max-w-3xl mx-auto mb-8 animate-fadeIn delay-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-gray-800 rounded-xl p-6 hover:bg-gray-700 transition-all duration-300 transform hover:scale-105">
                ...
                <div className="mt-4">
                  <a href={member.social.linkedin} className="text-white hover:text-gray-400 mr-4">LinkedIn</a>
                  <a href={member.social.twitter} className="text-white hover:text-gray-400">Twitter</a>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {premiumServices.map((service, index) => (
              <div
                key={index}
                className="bg-gray-900 rounded-xl shadow-lg p-8 transition-all transform hover:scale-105 hover:shadow-2xl"
              >
